#List of all columns used in the time series mergeing operation
ts_cols = ['STATE_CODE_001',
           ...
           'APPR_ROAD_EVAL_072',
           'SCOUR_CRITICAL_113',
           'SUFFICIENCY_RATING','BRIDGE_CONDITION']


#Code conversion dictionary for scour critical data column
Scour_Critical_Dict = {
    ...
    '3': 'Bridge is scour critical; bridge foundations determined to be unstable for calculated scour conditions: Scour within limits of footing or piles. Scour below spread-footing base or pile tips.',
...
#Code conversion dictionary for strucutre evaluation code columns

Structure_Appraisal_Rating_Dict = {
    '0': 'Bridge closed',
...
#List of all the columns used for identifying the 2019 columns needed
use_cols_2020 = ['STATE_CODE_001',
    'STRUCTURE_NUMBER_008',
    'DIRECTION_005E',
    'COUNTY_CODE_003',
    'FEATURES_DESC_006A',
...
Formatted_Col_Names_2020 = ['STATE_CODE', 'STRUCTURE_NUMBER', 'ROUTE_PREFIX', 'SERVICE_LEVEL', 'DIRECTION', 'COUNTY_CODE', 'PLACE_CODE', 'FEATURES_DESC', 'FACILITY_CARRIED', 'LOCATION', 'MIN_VERT_CLR', 'LAT', 'LONG', 'DETOUR_KILOS', 'TOLL', 'MAINTENANCE', 'FUNCTIONAL_CLASS', 'YEAR_BUILT', 'TRAFFIC_LANES_ON', 'TRAFFIC_LANES_UND', 'ADT', 'YEAR_ADT', 'DESIGN_LOAD', 'APPR_WIDTH_MT', 'MEDIAN_CODE', 'DEGREES_SKEW', 'STRUCTURE_FLARED', 'RAILINGS', 'TRANSITIONS', 'APPR_RAIL', 'APPR_RAIL_END', 'HISTORY', 'NAVIGATION', 'NAV_VERT_CLR_MT', 'NAV_HORR_CLR_MT', 'OPEN_CLOSED_POSTED', 'SERVICE_ON', 'SERVICE_UND', 'STRUCTURE_KIND', 'STRUCTURE_TYPE', 'APPR_KIND', 'APPR_TYPE', 'MAIN_UNIT_SPANS', 'APPR_SPANS', 'HORR_CLR_MT', 'MAX_SPAN_LEN_MT', 'STRUCTURE_LEN_MT', 'LEFT_CURB_MT', 'RIGHT_CURB_MT', 'ROADWAY_WIDTH_MT', 'DECK_WIDTH_MT', 'VERT_CLR_OVER_MT', 'VERT_CLR_UND_REF', 'VERT_CLR_UND', 'LAT_UND_REF', 'LAT_UND_MT', 'LEFT_LAT_UND_MT', 'DECK_COND', 'SUPERSTRUCTURE_COND', 'SUBSTRUCTURE_COND', 'CHANNEL_COND', 'CULVERT_COND', 'OPR_RATING_METH', 'OPERATING_RATING', 'INV_RATING_METH', 'INVENTORY_RATING', 'STRUCTURAL_EVAL', 'DECK_GEOMETRY_EVAL', 'UNDCLRENCE_EVAL', 'POSTING_EVAL', 'WATERWAY_EVAL', 'APPR_ROAD_EVAL', 'WORK_PROPOSED', 'WORK_DONE_BY', 'IMP_LEN_MT', 'DATE_OF_INSPECT', 'INSPECT_FREQ_MONTHS', 'FRACTURE', 'UNDWATER_LOOK_SEE', 'SPEC_INSPECT', 'FRACTURE_LAST_DATE', 'UNDWATER_LAST_DATE', 'SPEC_LAST_DATE', 'BRIDGE_IMP_COST', 'ROADWAY_IMP_COST', 'TOTAL_IMP_COST', 'YEAR_OF_IMP', 'OTHER_STATE_CODE', 'OTHER_STATE_PCNT', 'STRAHNET_HIGHWAY', 'PARALLEL_STRUCTURE', 'TRAFFIC_DIRECTION', 'TEMP_STRUCTURE', 'HIGHWAY_SYSTEM', 'FEDERAL_LANDS', 'YEAR_RECONSTRUCTED', 'DECK_STRUCTURE_TYPE', 'SURFACE_TYPE', 'MEMBRANE_TYPE', 'DECK_PROTECTION', 'PERCENT_ADT_TRUCK', 'NATIONAL_NETWORK', 'PIER_PROTECTION', 'SCOUR_CRITICAL', 'FUTURE_ADT', 'YEAR_OF_FUTURE_ADT', 'MIN_NAV_CLR_MT', 'BRIDGE_CONDITION', 'LOWEST_RATING', 'DECK_AREA']
...
red_fin_col_list = ['DECK_COND_COMBINED',
                     'SUPERSTRUCTURE_COND_COMBINED',
                     'SUBSTRUCTURE_COND_COMBINED',
                     'CHANNEL_COND_COMBINED',
                     'CULVERT_COND_COMBINED',
                     'STRUCTURAL_EVAL_COMBINED',
                     'DECK_GEOMETRY_EVAL_COMBINED',
                     'WATERWAY_EVAL_COMBINED',
                     'APPR_ROAD_EVAL_COMBINED',
                     'SCOUR_CRITICAL_COMBINED',
                     'SUFFICIENCY_RATING_COMBINED',
                     'BRIDGE_CONDITION_COMBINED']
...
Service_Level_Dict = {
    ...
    '8': 'Service and/or Unclasified Frontage Road',
}
...
#TOLL_020
Toll_Dict = {
    '1':'Toll Bridge, Non-Toll Road',
    '2':'Non-Toll Bride, Toll Road',
    '3':'Non-Toll Bridge, Non-Toll Road',
    '4':'Interstate Toll',
    '5':'Highway Toll'
}
...
#FUNCTIONAL_CLASS_026
Functional_Classification_Dict = {
...
Traffic_Safety_Feature_Dict = {
    '0':'Inspected feature does not meet currently acceptable standards or a safety feature isrequired and none is provided',
    '1':'Inspected feature meets currently acceptable standards',
    'N':'Not Applicable or Safety Feature Not Required'
}
...
#NAVIGATION_038
Navigation_Control_Feature_Dict = {
...
Structure_Open_Closed_Posted_Dict = {
...
Service_On_Dict = {
    ...
    '6': 'Overpass Structure at an interchange or second level of a multi-level interchange',
...
#use for structure kind and approach kind
#STRUCTURE_KIND_043A
#APPR_KIND_044A
Structure_Kind_Dict = {
    '0': 'Other',
...
#use for structure type main and approach type 
#STRUCTURE_TYPE_043B
#APPR_TYPE_044B
Structure_Type_Dict = {
    '00':'Other',
...
Condition_Rating_Dict = {
    ...
    '1': 'EMMINENT" FAILURE CONDITION - major deterioration or section loss present in critical structural components or obvious vertical or horizontal movement affecting structure stability. Bridge is closed to traffic but corrective action may put back in light service.',
...
Condition_Rating_Dict_Short = {
    '0': 'FAILED CONDITION',
    '1': 'EMMINENT" FAILURE CONDITION',
...
Strahnet_Highway_Designation_Dict = {
    ...
    '3':'The inventory route is on a STRAHNET connectorroute.',
}

#PARALLEL_STRUCTURE_101

Parallel_Structure_Dict = {
...
#STATE_CODE (Note this is the old style newer dates use the FIPS system codes)
state_code_dict = {
    '014': 'Alabama',
    '020': 'Alaska',
    '049': 'Arizona',
...
maintenance_responsibility_dict = {
    '1':'Other',
