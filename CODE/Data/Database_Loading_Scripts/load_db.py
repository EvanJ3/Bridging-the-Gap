...
# information on bridge formatting: https://www.fhwa.dot.gov/bridge/nbi/format.cfm
# guide on the data/columns: https://www.fhwa.dot.gov/bridge/mtguide.pdf
# state codes https://nationalbridges.com/nbiDesc.html#ITEM_1 
...
# data = pd.read_csv('Highway_Bridges_2020.csv', encoding = "ISO-8859-1")

# file_list = ["Cleaned_Full_Data.csv"]
file_list = ["Cleaned_Full_Data_V6.csv"]
